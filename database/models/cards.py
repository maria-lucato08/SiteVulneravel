...
class Card_info(Model): # Define a classe Card_info que herda de Model, representando a tabela de cartões no banco de dados #
    titularEmail = ForeignKeyField(User_info, backref='cards') # Define uma chave estrangeira para a tabela de usuários, relacionando os cartões aos seus respectivos usuários #
